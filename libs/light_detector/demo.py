...
import torch
import numpy as np
from ultra_models import nets
from ultra_models.ssd.prior_boxes import PriorBoxes
from ultra_models.nms import py_bbox_nms
from pybaseutils import image_utils, file_utils
from ultra_models import box_utils
...
def get_parser():
    ...
    parser.add_argument('--model_file', default=model_path, type=str, help='')
    parser.add_argument('--out_dir', default="", type=str, help='')
    parser.add_argument('--video_file', default="", type=str, help='')
    ...
    parser.add_argument('--device', default="cuda", type=str, help='cuda:0 or cpu')
...
class Detector(object):
    ...
    def build_net(self, model_path, net_type):
        ...
        name_map = {
            "backbone": "base_net",
            "extra_layer": "extras",
            "class_headers": "classification_headers",
            "bbox_headers": "regression_headers",
            "landm_headers": "landms_headers",
        }
    ...
    def detect_image(self, rgb_image, vis=True):
        """
    ...
    def show_image(self, rgb_image, boxes, labels, probs, waitKey=0):
        ...
        rgb_image = image_utils.draw_image_detection_bboxes(rgb_image, boxes, probs, labels)
