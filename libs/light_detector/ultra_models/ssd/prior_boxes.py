...
import math
import torch
from ultra_models.config import config
...
if __name__ == "__main__":
    ...
    anchors = image_utils.center2bboxes(anchors)
    boxes_list = image_utils.convert_anchor(anchors, height=input_size[1], width=input_size[0])
    for i, b in enumerate(boxes_list):
        image_utils.show_image_boxes("anchors", image, [b], color=(255, i * 20 % 255, i * 20 % 255))
