...
class SSD(nn.Module):
    def __init__(self, num_classes: int, base_net: nn.ModuleList, source_layer_indexes: List[int],
                 ...
                 regression_headers: nn.ModuleList, is_test=False, prior_boxes=None, device=None):
    ...
    def compute_header(self, i, x):
        """
        0 torch.Size([32, 64, 45, 60])
        1 torch.Size([32, 128, 23, 30])
        2 torch.Size([32, 256, 12, 15])
        3 torch.Size([32, 256, 6, 8])
        :param i:
        :param x:
        :return:
        """
